...
const CHAT_HINT_RE = /\b(?:oi|ola|olá|bom dia|boa tarde|boa noite|blz|beleza|valeu)\b/i;
const TECHNICAL_HINT_RE =
  /\b(?:api|json|http|https|sql|typescript|javascript|react|electron|azure|prompt|regex|sdk)\b/i;

function inferFromFormatStyle(formatStyle?: TranscriptFormatStyle): TranscriptIntent | null {
  if (formatStyle === 'bullet-list' || formatStyle === 'notes') return 'bullet-list';
