...
const api = {
  ...
  getAzureCredentialStatus: () => ipcRenderer.invoke('app:azure-credentials-status'),
  testAzureCredentials: (payload) => ipcRenderer.invoke('app:azure-credentials:test', payload),
  saveAzureCredentials: (payload) => ipcRenderer.invoke('app:azure-credentials:save', payload),
  clearAzureCredentials: () => ipcRenderer.invoke('app:azure-credentials:clear'),
  getHealthCheck: (payload) => ipcRenderer.invoke('app:health-check', payload ?? {}),
  ...
  dismissAdaptiveSuggestion: (id) => ipcRenderer.invoke('adaptive:dismiss', { id }),
