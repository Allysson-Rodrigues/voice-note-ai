...
const api = {
  ...
  getAzureCredentialStatus: () =>
    ipcRenderer.invoke("app:azure-credentials-status"),
  testAzureCredentials: (payload) =>
    ipcRenderer.invoke("app:azure-credentials:test", payload),
  saveAzureCredentials: (payload) =>
    ipcRenderer.invoke("app:azure-credentials:save", payload),
  clearAzureCredentials: () =>
    ipcRenderer.invoke("app:azure-credentials:clear"),
  getHealthCheck: (payload) =>
    ipcRenderer.invoke("app:health-check", payload ?? {}),
  getPerfSummary: () => ipcRenderer.invoke("app:perf-summary"),
  getRecentLogs: (params) =>
    ipcRenderer.invoke("app:logs:recent", params ?? {}),
  listAdaptiveSuggestions: () => ipcRenderer.invoke("adaptive:list"),
  applyAdaptiveSuggestion: (id) => ipcRenderer.invoke("adaptive:apply", { id }),
  dismissAdaptiveSuggestion: (id) =>
    ipcRenderer.invoke("adaptive:dismiss", { id }),
  retryHoldHook: () => ipcRenderer.invoke("app:retry-hold-hook"),
  updateSettings: (partial) => ipcRenderer.invoke("settings:update", partial),
  setAutoPasteEnabled: (enabled) =>
    ipcRenderer.invoke("settings:autoPaste", { enabled }),
