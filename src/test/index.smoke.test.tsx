...
describe("Index smoke", () => {
  it("renders dictionary tab and helper text", async () => {
    const api = {
      ...
      addDictionaryTerm: async () => ({ ok: true, term: { id: "1", term: "standup", enabled: true, createdAt: "" } }),
      updateDictionaryTerm: async () => ({ ok: true, term: { id: "1", term: "standup", enabled: true, createdAt: "" } }),
      ...
      setToneMode: async (mode: "formal" | "casual" | "very-casual") => ({ ok: true, toneMode: mode }),
      onHudState: () => () => {},
      onCaptureStart: () => () => {},
      onCaptureStop: () => () => {},
      onSttPartial: () => () => {},
