...
const Index = () => {
  ...
  const hasDesktopApi =
    typeof window !== "undefined" && Boolean(window.voiceNoteAI);
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          gridTemplateRows: isSidebarExpanded ? "auto 1fr" : "auto 1fr",
        }}
      >
        <header
        ...
        >
          <div className="flex items-center gap-3">
            <Button
              ...
              aria-label={
                isSidebarExpanded ? "Recolher navegação" : "Expandir navegação"
              }
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <div
                className={`h-2 w-2 rounded-full ${STATUS_DOT_CLASS[headerStatus]}`}
              />
        ...
        <div
          ...
          style={{
            gridTemplateColumns: isSidebarExpanded
              ? "248px minmax(0, 1fr)"
              : "80px minmax(0, 1fr)",
          }}
        >
            ...
            >
              <TabsList className="w-full">
                {NAV_ITEMS.map(({ value, label, icon: Icon }) => (
                  ...
                  >
                    <Icon
                      className={isSidebarExpanded ? "mr-2 h-4 w-4" : "h-4 w-4"}
                    />
